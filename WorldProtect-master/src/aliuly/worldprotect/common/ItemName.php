...
abstract class ItemName
{
     ...
     */
    protected static function initXnames()
    {
        self::$xnames = [Item::DYE => [0 => "Ink Sac", 1 => "Rose Red", 2 => "Cactus Green", 3 => "Cocoa Beans", 4 => "Lapis Lazuli", 5 => "Purple Dye", 6 => "Cyan Dye", 7 => "Light Gray Dye", 8 => "Gray Dye", 9 => "Pink Dye", 10 => "Lime Dye", 11 => "Dandelion Yellow", 12 => "Light Blue Dye", 13 => "Magenta Dye", 14 => "Orange Dye", 15 => "Bone Meal", "*" => "Dye"], Item::SPAWN_EGG => ["*" => "Spawn Egg", 32 => "Spawn Zombie", 33 => "Spawn Creeper", 34 => "Spawn Skeleton", 35 => "Spawn Spider", 36 => "Spawn Zombie Pigman", 37 => "Spawn Slime", 38 => "Spawn Enderman", 39 => "Spawn Silverfish", 40 => "Spawn Cave Spider", 41 => "Spawn Ghast", 42 => "Spawn Magma Cube", 10 => "Spawn Chicken", 11 => "Spawn Cow", 12 => "Spawn Pig", 13 => "Spawn Sheep", 14 => "Spawn Wolf", 16 => "Spawn Mooshroom", 17 => "Spawn Squid", 19 => "Spawn Bat", 15 => "Spawn Villager"]];
    }
    /**
